...
class TimeCardsControllerTest < ActionController::TestCase
  ...
  test "should create time_card" do
    assert_difference('TimeCard.count') do
      post :create, time_card: { check_in: @time_card.check_in, check_out: @time_card.check_out, limit: @time_card.limit }
    end
  ...
  test "should update time_card" do
    patch :update, id: @time_card, time_card: { check_in: @time_card.check_in, check_out: @time_card.check_out, limit: @time_card.limit }
    assert_redirected_to time_card_path(assigns(:time_card))
  end
